...
print("Fight {element name} -- Use this command to Fight with someone")
print("Break {element name} -- Use this command to break something ")
print("Inventory -- Use this command to check what things you have with you")
print("I -- Use this command to check what things you have with you")
print("Quit -- Use this command to quit the game.")
print("Q-- Use this command to quit the game.")
#print("Flee {direction} -- Use this command to runaway from a place")
